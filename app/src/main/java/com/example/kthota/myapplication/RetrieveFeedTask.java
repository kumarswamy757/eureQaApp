package com.example.kthota.myapplication;
...
//        String split=params[0].
        ...
        try {
	        /*URL url = new URL ("https://www.eureqatest.com/rest/v1/eureqasandbox/executions?allStatuses=true&from=1468562287");
	        String encoding = Base64.encodeBytes(("eureqa" + ":" + "eur3Q@123").getBytes("UTF-8"));
...
//	        Toast.makeText(MainActivity.this,line1,Toast.LENGTH_LONG).show();
